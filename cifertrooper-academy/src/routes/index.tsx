    ...
    <div className="bg-card text-foreground selection:bg-accent selection:text-white overflow-x-hidden">
      ...
      <section className="relative min-h-[90vh] flex flex-col items-center justify-center pt-20 px-6 text-center overflow-hidden bg-surface">
        ...
        >
          ...
          <h1 className="text-6xl md:text-8xl font-bold tracking-tighter mb-6">
            {hero?.heading ? (
              <>Your Gateway to <br /><span className={gradientText}>{hero.heading}</span></>
            ) : (
              <>Your Gateway to <br /><span className={gradientText}>Cyber Excellence.</span></>
            )}
          </h1>
      ...
      <section className="py-12 border-y border-border bg-card">
        <div className="max-w-7xl mx-auto px-6 grid grid-cols-2 md:grid-cols-4 gap-8">
          {[
            { label: "Expert Instructors", value: "10+", icon: Users },
            { label: "Hands-on Modules", value: "500+", icon: BookOpen },
            { label: "Students Certified", value: "2000+", icon: Award },
            ...
            >
              <stat.icon className="size-6 text-accent mb-2" />
      ...
      <section id="catalog" className="py-24 px-6 md:px-12 max-w-7xl mx-auto scroll-mt-20">
        <div className="text-center mb-16">
          <h2 className="text-4xl md:text-6xl font-bold mb-6">
            Academy <span className={gradientText}>Catalog</span>
          </h2>
          <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
            Explore our 12 specialized programs designed for the next generation of security researchers and developers.
          </p>
        </div>
          ...
          <div className="grid md:grid-cols-2 gap-16 items-center">
            ...
            <div className="space-y-8">
              ...
              <div className="space-y-6">
                {[
                  { title: "Practical Labs", desc: "We don't just teach theory. Every module includes intensive practical sessions using industry tools." },
                  { title: "Real-world Projects", desc: "Build tools and perform penetration tests that reflect real-world scenarios." },
                  { title: "Lifetime Mentorship", desc: "Our instructors are always there to guide you, even after you complete your course." }
                ].map((item, i) => (
                  <motion.div 
                    key={i}
                    className="flex gap-4 p-6 rounded-2xl bg-card border border-border/50 hover:border-accent transition-colors shadow-sm"
        ...
        <div className="container-page grid md:grid-cols-2 gap-16 items-center">
          <div className="relative">
            ...
            <motion.img 
              src={smileIcon} 
              alt="" 
              className="absolute -top-4 -right-4 w-24 drop-shadow-lg"
          ...
          <div>
            ...
            <p className="text-2xl md:text-3xl font-light leading-relaxed mb-8 italic">
              "The Red Team Field course was a game-changer. The hands-on PCB design and ethical hacking modules gave me skills I couldn't find anywhere else."
            </p>
            <div>
              <h4 className="text-xl font-bold">Kavimugil R.</h4>
              <p className="text-accent text-sm font-bold uppercase tracking-widest">Alumni - 2024</p>
            </div>
          </div>
        </div>
      </section>
