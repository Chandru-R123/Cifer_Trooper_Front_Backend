...
const SERVICES_DATA: Record<string, ServiceDetail> = {
  "custom-app-development": {
    ...
    subtitle:
      "We develop customized, ready-to-launch clones of the world’s most popular apps, tailored for your market",
        ...
        items: [
          {
            ...
            description:
              "Build your own Uber-like taxi booking app with real-time GPS tracking, driver earnings dashboard, and multiple payment gateways.",
          ...
          },
          {
            ...
            description:
              "Empower entrepreneurs to build multi-service super apps offering ride-hailing, food delivery, and logistics — all in one platform.",
          ...
          },
          {
            ...
            description:
              "Build engaging social media and dating apps. Our Tinder clone comes with swipe features, AI-driven matching, and chat tools.",
          ...
          },
          {
            ...
            description:
              "Launch your own e-learning clone app to tap into the digital education space with course marketplaces and live sessions.",
    ...
    faqs: [
      {
        ...
        answer:
          "A clone app is a ready-made solution inspired by top apps like Uber or Amazon, built with unique source code and customized branding.",
      },
      {
        question: "How long does it take to launch?",
        answer:
          "On average, clone apps can be launched in 6–10 weeks, depending on complexity and integrations.",
      },
      {
        question: "Do you provide marketing services?",
        answer:
          "Absolutely. We provide App Store Optimization (ASO), digital marketing, and branding to ensure your app succeeds.",
      },
    ],
  },
  "website-development": {
        ...
        items: [
          {
            ...
            description:
              "Professional, scalable, and brand-focused websites for businesses of all sizes. We integrate AI for personalized user journeys.",
          },
          {
            title: "CMS & E-Commerce Solutions",
            image: "/assets/images/services/cms.jpg",
            description:
              "Manage your content with ease using WordPress or Webflow. From single-brand stores to multi-vendor marketplaces.",
          },
        ],
      },
    ],
    ...
    faqs: [
      ...
      },
      {
        ...
        answer:
          "Yes - we integrate AI chatbots, personalization engines, and smart automation into websites.",
      },
    ],
  },
    ...
    sections: [
      {
        ...
        items: [
          ...
          },
          {
            ...
            description:
              "Comprehensive guides covering color palettes, typography, and usage rules.",
          },
        ],
      },
    ],
        ...
        items: [
          {
            ...
            description:
              "Modern interfaces for Android and iOS apps, as well as responsive website designs.",
          },
          {
            title: "Wireframing & Prototyping",
            image: "/assets/images/services/wire.jpg",
            description:
              "Visual layouts and interactive prototypes to bring your vision to life before development.",
          },
        ],
      },
    ],
    ...
    faqs: [
      {
        ...
        answer:
          "UI (User Interface) design focuses on the look and feel, while UX (User Experience) ensures it is easy and intuitive to use.",
      },
    ],
  },
  "online-marketing": {
        ...
        items: [
          {
            ...
            description:
              "Climb search rankings with AI-powered SEO strategies and technical optimization.",
          ...
          },
          {
            ...
            description:
              "Drive traffic with Google Ads and social PPC campaigns managed with AI-driven bidding.",
    ...
    faqs: [
      {
        ...
        answer:
          "SEO is a long-term strategy; noticeable improvements typically appear in 3–6 months.",
      },
    ],
  },
        ...
        items: [
          {
            ...
            description:
              "Custom workflows using Zapier and n8n to integrate your apps and automate repetitive tasks.",
          ...
          },
          {
            ...
            description:
              "AI chatbots for websites and WhatsApp that capture leads and provide 24/7 support.",
    ...
    sections: [
      {
        ...
        items: [
          ...
          },
          {
            ...
            description:
              "Build platforms like Amazon with vendor dashboards and secure management.",
    ...
    faqs: [
      {
        ...
        answer:
          "Yes - we develop multi-vendor marketplaces with vendor dashboards and scalable infrastructure.",
      },
    ],
  },
};
...
export const Route = createFileRoute("/services_/$slug")({
  head: () => ({ meta: [{ title: "Service — CiferTrooper" }] }),
...
function ServiceDetailPage() {
  ...
  useEffect(() => {
    ...
    apiGet<ServiceDetail>(`/api/services/${slug}`)
      .then(setData)
      .catch(() => {
