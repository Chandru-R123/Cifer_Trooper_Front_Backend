...
export const Route = createFileRoute("/services/")({
  head: () => ({
    meta: [
      { title: "Our Services — CiferTrooper" },
      {
        name: "description",
        content:
          "Comprehensive digital solutions: Clone App Development, UI/UX, Website Engineering, and AI Automation.",
      },
    ],
  }),
  ...
  services: [
    {
      ...
      description:
        "Build your own version of popular apps like Uber, Gojek, Netflix, OnlyFans, Zomato, and more customized for your brand.",
      image: cloneImg,
    ...
    },
    {
      ...
      description:
        "Create a strong identity with professional logo design and complete brand kits that stand out in the marketplace.",
      image: brandingImg,
    ...
    },
    {
      ...
      title: "UI / UX Design",
      description:
        "Modern, user-friendly interfaces for mobile apps and websites designed for maximum engagement and retention.",
      image: uiuxImg,
    ...
    },
    {
      ...
      description:
        "SEO-friendly, responsive websites built with the latest technologies to ensure performance and scalability.",
      image: webImg,
    ...
    },
    {
      ...
      description:
        "Launch an online store with seamless payment gateway integration and mobile-first shopping experiences.",
      image: ecomImg,
    ...
    },
    {
      ...
      description:
        "Turn unique ideas into powerful apps for iOS and Android, fully custom-built to match your business vision.",
      image: customImg,
      link: "/services/custom-app-development",
    },
    {
      ...
      description:
        "SEO, social media marketing, and high-conversion ad campaigns to grow your business globally.",
      image: marketingImg,
    ...
    },
    {
      ...
      description:
        "Work smarter with intelligent chatbots and AI-driven automation to reduce manual tasks and improve CX.",
      image: aiImg,
...
const gradientText =
  "bg-clip-text text-transparent bg-gradient-to-r from-accent via-amber-500 to-purple-600";
          ...
          >
            {["STRATEGY", "DESIGN", "DEVELOPMENT", "MARKETING", "AUTOMATION"].map((text) => (
              <div key={text} className="flex items-center gap-12">
                <span className="text-6xl md:text-8xl font-black text-slate-100 tracking-tighter uppercase">
                  {text}
                </span>
