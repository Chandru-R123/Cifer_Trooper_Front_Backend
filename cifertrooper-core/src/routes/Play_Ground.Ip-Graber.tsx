        ...
        >
          <div>
            ...
            <p className="text-muted-foreground text-lg max-w-2xl">
              Monitor and manage your active tracking links. View real-time logs of captured
              interactions.
            </p>
          </div>
          <div className="flex gap-2">
            ...
            <Button className="rounded-xl px-6">Create New Link</Button>
          </div>
        </motion.div>
              ...
              <Table>
                ...
                <TableBody>
                  {logs.map((log) => (
                    ...
                    >
                      <TableCell className="font-mono font-medium text-accent">{log.ip}</TableCell>
