...
export const Route = createFileRoute("/contact-us")({
  head: () => ({
    meta: [
      { title: "Contact CiferTrooper — Let's Build Something Great" },
      {
        name: "description",
        content:
          "Reach out to the CiferTrooper team for app development, UI/UX design, or digital marketing inquiries.",
      },
    ],
  }),
...
const initialData: ContactData = {
  hero: {
    ...
    subtitle:
      "Cifer Trooper turns ideas into stunning apps, websites, and brands. Tell us about your project and we'll reply within 24 hours.",
  },
  info: {
...
function ContactPage() {
  ...
  // Un-comment this block to enable dynamic content from the backend
  useEffect(() => {
    async function load() {
      try {
        const res = await apiGet<ContactData>("/api/pages/contact-us");
          ...
          >
            <div className="space-y-6">
              ...
              <p className="text-slate-500">
                Have a question or ready to start? We're here to help you navigate your digital
                transformation.
              </p>
            </div>
...
function SocialCircleLink({
  ...
  href: string;
  icon: ReactNode;
  brand: "facebook" | "instagram" | "twitter" | "linkedin";
}) {
